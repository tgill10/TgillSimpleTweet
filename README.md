...
<img src='https://i.imgur.com/n7HUELO.gifv'
## Notes

The challenges I've had were first not being authoized to create a app on developer twitter. You will see that on my emulator that it won't go pass my login screen. I've had to manually put in the code and links that were used from twitter developer
